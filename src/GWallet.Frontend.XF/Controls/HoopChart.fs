...
type HoopChartView() =
    ...
    member this.ArrangeChildren(layoutBounds: Rect) = 
        ...
        | Empty -> 
#if XAMARIN
            emptyStateWidget.Layout layoutBounds
#else
        ...
        | NonEmpty(segments) -> 
            ...
            let bounds = 
                ...
                Rectangle.FromLTRB(
                    ...
                    layoutBounds.Y + yOffset, 
                    layoutBounds.X + xOffset + smallerSide, 
                    layoutBounds.Y + yOffset + smallerSide)
#else
    ...
    override this.LayoutChildren(xCoord, yCoord, width, height) = 
        this.ArrangeChildren(Rectangle.FromLTRB(xCoord, yCoord, xCoord + width, yCoord + height))
        |> ignore
...
and HoopChartLayoutManager(hoopChart: HoopChartView) =
    ...
    override this.Measure(widthConstraint, heightConstraint) = 
        ...
        base.Measure(requestedSize.Width, requestedSize.Height)
